...
Screenshot Reference: Burp Suite - Repeater with shrek.jpg payload

With the .htaccess file in place, I re-uploaded the web shell disguised as shrek.jpg. The payload contained:
...
After navigating to the uploaded file, the server executed the PHP code and returned the contents of /home/carlos/secret, revealing the flag:

Code
c7n4uLqfKVUoHuoDdnAhr7Q4N-J84Rk4R
